    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ...
            var model = new IndexViewModel
            {
                ...
                Props=db.Props.Where(x=>x.AuthorId==userId).Include(r=>r.PropsCategory).ToList(),
        ...
        public ActionResult CreateProps()
        {
            ViewBag.PropsCategoryId = new SelectList(db.PropsCategories, "Id", "Name");
            var p=new Props();
